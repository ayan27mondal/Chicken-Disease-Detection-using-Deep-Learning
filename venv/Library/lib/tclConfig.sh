...
# installed.
TCL_PREFIX='E:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='E:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='E:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IE:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library\include'
...
TCL_PACKAGE_PATH='E:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LE:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='E:/7th_Sem/Machine Learning/chicken_dieases_classification/venv\Library\lib\tclstub86.lib'
